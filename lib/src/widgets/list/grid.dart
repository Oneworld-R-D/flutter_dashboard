...
class FlutterDashboardGridDelegates {
  ...
  static SliverGridDelegate columns_2({
    required double width,
    required int? length,
  }) =>
      fit(length, 2, 1);
  static SliverGridDelegate columns_1({
    required double width,
    required int? length,
  }) =>
      fit(length, 1, 1);
  static SliverGridDelegate columns_3({
    required double width,
    required int? length,
  }) =>
      fit(length, 3, 1);
  static SliverGridDelegate columns_4({
    required double width,
    required int? length,
  }) =>
      fit(length, 4, 1);
  static SliverGridDelegate columns_5({
    required double width,
    required int? length,
  }) =>
      fit(length, 5, 1);
  static SliverGridDelegate columns_6({
    required double width,
    required int? length,
  }) =>
      fit(length, 6, 1);

  static SliverGridDelegate responsive({
